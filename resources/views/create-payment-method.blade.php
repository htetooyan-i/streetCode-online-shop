<form action="" class="shadow-lg p-5 rounded-lg border border-gray-200" method="post">
    ...
    <div class="">
        <ul class="grid w-full gap-2 grid-cols-3 mb-5">
                <li>
                    <input type="radio" id="google-pay" name="payment" value="google-pay" class="hidden peer" required />
                ...
                <li>
                    <input type="radio" id="visa-card" name="payment" value="visa-card" class="hidden peer" required />
                ...
                <li>
                    <input type="radio" id="apple-pay" name="payment" value="apple-pay" class="hidden peer" required />
        ...
        <div class="grid md:grid-cols-2 md:gap-6">
            ...
            <div class="relative z-0 w-full mb-5 group">
                <input type="number" name="floating_CVV" id="floating_CVV" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-black focus:outline-none focus:ring-0 focus:border-black peer" placeholder=" " required />
